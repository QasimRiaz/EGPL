...
if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
        $config = array(
            ...
            'api_url' => 'https://api.github.com/repos/QasimRiaz/EPGL', // the GitHub API url of your GitHub repo
            'raw_url' => 'https://raw.github.com/QasimRiaz/EPGL/master', // the GitHub raw url of your GitHub repo
            'github_url' => 'https://github.com/QasimRiaz/EPGL', // the GitHub url of your GitHub repo
            'zip_url' => 'https://github.com/QasimRiaz/EPGL/zipball/master', // the zip url of the GitHub repo
