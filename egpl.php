...
if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
        $config = array(
            ...
            'raw_url' => 'https://github.com/QasimRiaz/EGPL/tree/4.x', // the GitHub raw url of your GitHub repo
            'github_url' => 'https://github.com/QasimRiaz/EGPL', // the GitHub url of your GitHub repo
            'zip_url' => 'https://github.com/QasimRiaz/EGPL/archive/4.x.zip', // the zip url of the GitHub repo
