...
if (current_user_can('administrator') || current_user_can('contentmanager')) {
   ...
   <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <button  name="addsponsor" style="float: right;"  class="addnewbulktask btn btn-inline mycustomwidth btn-info" value="Register">Add New Task</button>
...
<div class="form-group row">
                <table  class="bulkedittask  table-bordered compact dataTable no-footer cards"  >
                    <thead>
                        <tr class="text_th" >
                            <th >Action</th>
                            <th >Title</th>
                    ...
                    <tbody>
                        ...
                        <tr >
                            <td><p style="margin-top: 10px;margin-bottom: 10px;"><i class="fa fa-clone" style="color:#262626;cursor: pointer;" title="Create a clone" aria-hidden="true"></i><i style=" cursor: pointer;margin-left: 10px;" title="Remove this task" onclick="removebulk_task(this)"class="fusion-li-icon fa fa-times-circle " style="color:#262626;"></i></p></td>
...
<div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <button  name="addsponsor2" style="float: right;"  class="addnewbulktask btn btn-inline mycustomwidth btn-info" value="Register">Add New Task</button>
