...
jQuery(document).ready(function () {
 ...
 if ( window.location.href.indexOf("task-report-filters") > -1)
    {
...
// init
    ...
    var urlnew = url + 'wp-content/plugins/EGPL/userreport.php?contentManagerRequest=gettasksreport';
           ...
           jQuery('#builder').queryBuilder(options);
            ...
            if(tech == 'edit'){
                 ...
                 if(showcollist == ""){
                    ...
                    window.location.href = url+"/task-report-filters/";
                 }
