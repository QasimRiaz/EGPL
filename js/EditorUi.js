                                        ...
                                        if(userid !="" && userid != "none" && reportData){
                                            ...
                                            jQuery.each(reportData, function(key,index){ 
                                                if(index.exhibitorsid == userid){
                                                 ...
                                                 var imagesrc = "<div class='row'><div class='col-sm-6'><p><h5>"+companynameas+"</h5></a></p></div><div class='col-sm-3'><p style='text-align:center;margin-top: 18px;'><img width='100' src='"+companylogourlnew+"' /></p></div></div><hr>";
                                           ...
                                           if(boothproductid !="" && boothproductid !="undefined" && boothproductid !="none"){
                                                ...
                                                jQuery.ajax({
                                                    ...
                                                    success: function(data) {
                                                        ...
                                                        console.log(finalresultProduct);
                                                         ...
                                                         var productprice = '<p><h5 ><strong>Price: </strong>' + finalresultProduct.price + '</h5>';
                                                        ...
                                                        var productICon = "<p style='text-align:center;margin-top: 25px;'><img width='125' src='"+finalresultProduct.src+"'></p>";
                                                     ...
                                                     htmlcompanydescription = '<h6 ><div style="text-align: justify;">'+unescape(companydescription)+'</div></h6>';
                                                      ...
                                                      if(finalresultProduct.productstatus == "exist"){ 
                                                         ...
                                                         var openhtml = '<div class="row customedivproductview" ><div class="col-sm-7" >'+productprice+''+boothtitle+productDescription+'</div><div class="col-sm-3">'+productICon+'</div></div>';	
                                                         var popupstatustitle = "Available for Purchase"; 
                                                        }else{
                                                            
                                                        var openhtml = '<div class="row customedivproductview" ><div class="col-sm-10" >'+boothtitle+htmlcompanydescription+'</div></div>';	
                                               ...
                                               var productDescription = '<h5 ><strong>Booth Description: </strong>' + htmlcompanydescription + '</h5>';
                                              ...
                                              // openhtml = '<div class="row"><div class="col-sm-4" style="margin-top: 2%;">'+htmlforassignedbooth+'<hr>'+htmlcompanydescription+'</div><div class="col-sm-6"></div></div>';	
                                                ...
                                                //  var openhtml = '<div class="row" style="padding:30px;" ><div class="col-sm-5">'+imagesrc+''+htmlforaddress+''+htmlforassignedbooth+'<hr>'+htmlcompanydescription+'</div><div class="col-sm-5">'+htmlforproductdetail+'</div></div>';
                                                        var openhtml = '<div class="row customedivproductview" ><div class="col-sm-5" >'+boothtitle+''+productDescription+'</div><div class="col-sm-5"></div></div>';	
                                                ...
                                                jQuery('body').css('cursor', 'default');
                                                    jQuery.confirm({
                                                        title: '<i class="far fa-id-card"></i> Unavailable for Purchase',
                                                        content: newopenhtml,
                                                        confirmButton: false,
                                                        confirmButtonClass: 'mycustomwidth',
                                                        cancelButton: false,
		...
		else
		{
			this.editor.undoManager.redo();
                ...
                {       
                    ...
                    this.setPageFormat(new mxRectangle(0, 0, parseInt(currentbgImage.width), parseInt(currentbgImage.height)));

                });
                var currentbgImage = graph.getBackgroundImage();
                if(currentbgImage){
                    apply(new mxImage(currentbgImage.src, currentbgImage.width, currentbgImage.height));
...
EditorUi.prototype.createUi = function()
{
	...
	if (this.menubar != null)
	{
        ...
        if(mxCurrentfloorplanstatus !='viewer'){
            this.sitename = (this.editor.chromeless) ? null : this.menus.createMenubar(sitenamedive);
        }
        if (this.sitename != null)
	{
       ...
       // this.container.appendChild(this.menubarContainer);
        ...
        this.backtodashboard = (this.editor.chromeless) ? null : this.menus.createMenubar(backtodashboarddiv);
       // this.menubarContainer.appendChild(this.backtodashboard.container);
        ...
        helpbutton.innerHTML = '<i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;Help ';
...
EditorUi.prototype.createSiteTitleContainer = function()
{
        ...
        sitenamehtml.innerHTML  ='<a class="customemenulink" style="margin-left: 3%;" href="'+mxCurrentSiteUrl+'" target="_blank">'+mxCurrentSiteTitle+'</a>';
        return sitenamehtml;
};
...
EditorUi.prototype.showBackgroundImageDialog = function(apply)
{
	...
	{       
		...
		this.editor.graph.model.execute(change);
                this.setBackgroundImage(image);
                this.setPageFormat(new mxRectangle(0, 0, parseInt(image.width), parseInt(image.height)));
